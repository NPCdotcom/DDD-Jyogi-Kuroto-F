 ...
 *
 * <p>{@link core.domain.entity.Stats} 本体の 7 フィールドのうち、装備で増えると整合性が崩れる {@code currentHp} を除く 6 フィールドを保持する。
 * 全フィールドは 0 を許容 (装備によって特定ステだけ +1 する単発バフを表現可能)。負値も許容 (将来「呪い装備」「デバフ」を同型で扱う余地)。
 *
