    ...
    String[] lines =
        jp
            ? new String[] {
              ...
              "",
              "■ グラフィック素材",
              "    スキルカードアート 49 枚: チームメイト供与",
              "    マップタイル (壁 / 床): チームメイト供与",
              "    ステータスアイコン 6 種: チームメイト供与",
              "",
              "■ サウンド素材",
              "    BGM / SE: 未投入 (M2 で投入予定)",
              "",
            ...
            : new String[] {
              ...
              "",
              "[ Graphics ]",
              "    Skill card art (49 cards): Provided by team",
              "    Map tiles (wall / floor): Provided by team",
              "    Stat icons (6 kinds): Provided by team",
              "",
              "[ Sound ]",
              "    BGM / SE: TBD (M2)",
              "",
