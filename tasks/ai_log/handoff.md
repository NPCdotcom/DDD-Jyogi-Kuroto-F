...
- **日時**: 2026-05-14 (火) 深夜 (毎ターンドロー実装まで完了、移動カード化は明日 5/15 以降)
- **更新者**: Claude (本セッション)
...
- **2026-05-14 (今日)** ✅: **M1.5 コア機能完成 + 毎ターンドロー実装** (PR #13/#16/#17/#19/#21/#23、`gradlew run` 11 分動作確認済)
- **2026-05-15 (金)**: 移動カード化 + E-5 装備セット (新 ADR-20)、E-3 / E-4 / E-6 並列着手
