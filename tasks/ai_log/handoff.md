...
- **日時**: 2026-05-14 (火) 深夜 (解像度 1920×1080 化まで完了、E-5 装備 / 移動 α / E-6 UI は明日以降)
- **更新者**: Claude (本セッション)
...
- **2026-05-14 (今日)** ✅: **M1.5 コア + 毎ターンドロー + 解像度 1920×1080** (PR #13〜#26、ADR-20 まで蓄積)
- **2026-05-15 (金)**: 移動 α 案実装 + E-5 装備 (Equipment B 案) + 並列で E-3 / E-4 着手
