...
| セーフエリア | 上下左右 **各 20 px** は空ける。フレームと AP バッジが重なる領域 |
| 主題の配置 | 中央やや上寄り。下部 **96 px** はテキスト帯が重なるので、重要な要素を置かない |
...
**既存資産あり**: `assets/icons/cards/card_frame.png` が **96×112 px** で実在する。ただし 240×336 に対して小さすぎ、縦横比も 0.857 で 0.714 と合わないため、**そのままでは使えない**。
