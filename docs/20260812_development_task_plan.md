...
実行用のフレームとイラストは240×336の透過キャンバスへ統一し、手札では120×168へ等比縮小する。
...
- 各画像は240×336 RGBAで、枠、文字、数値、レアリティ記号を含まない。
...
| ゲート | 承認対象 | 通過しない場合の扱い |
|---|---|---|
| G0 | NPCdotcom制作フレームの編集原本、作者宣言、240×336書出し | CARD-02を開始しない |
