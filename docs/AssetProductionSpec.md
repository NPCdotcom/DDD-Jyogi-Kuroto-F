...
> ## ⚠ 本節は廃止されました (2026-08-13)
>
> **150×188 px と、下記の「AP 数字 / displayName 帯 / レアリティバッジを画像へ焼き込む」レイアウトは使用しないでください。**
>
> 名称・AP・レアリティ・効果文を画像へ焼き込んだ結果、実データと **59 枚中 43 枚が食い違い**、プレイヤーは表示と異なる AP でカードを使っていました。今後は「フレーム + イラストのみの画像 + 実行時テキスト」を合成します。
>
> **新規制作は [20260813_image_generation_brief.md](20260813_image_generation_brief.md) に従ってください** (寸法 240×336、文字・枠・背景を一切焼き込まない)。
>
> 本節は CARD-05 完了時に全面改稿します。それまでは旧仕様の履歴として残します。
